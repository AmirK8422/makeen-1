...
function Cards({title, text, image ,status} : Tcards) {
  ...
  function Status():any {
    ...
    return <button className='text-[#EB5757] bg-[rgba(236,60,54,0.1)] md:text-base text-xs font-medium md:px-2 md:pt-0.5 md:pb-1 p-1 rounded-lg gap-2 md:w-[108px] md:h-[33px] w-[76px] h-[28px]'>تکمیل ظرفیت</button>
  }
  }
